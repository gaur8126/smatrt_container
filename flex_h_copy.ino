...
const float R_DIV = 21300.0; // Measured resistance of 3.3k resistor
...
//SimpleKalmanFilter simpleKalmanFilter2(4, 2, 0.05);
//SimpleKalmanFilter simpleKalmanFilter3(2, 1, 0.05);
...
void loop() 
{
  ...
  // bend angle:
   float percent = map(flexR, STRAIGHT_RESISTANCE, BEND_RESISTANCE,
                   0, 100);
